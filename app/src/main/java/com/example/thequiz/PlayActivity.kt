...
import com.example.thequiz.databinding.ActivityPlayBinding
import java.util.*
...
class PlayActivity : AppCompatActivity() {
    ...
    private var questions = arrayOf(
        "Q.1. Entomology is a field of?",
        "Q.2. A week consists of how many days?",
        "Q.3. How many alphabets are there?",
        "Q.4. How many colors rainbow consists of?",
        "Q.5. Baby Frog is known as...",
        "Q.6. Name the largest Mammal",
        "Q.7. Largest planet in Solar System is..",
    ...
    private fun correctAlertDialog() {
        ...
        val view = LayoutInflater.from(this@PlayActivity).inflate(R.layout.activity_correct_answer, null)
    ...
    private fun wrongAlertDialog() {
        val builder = AlertDialog.Builder(this@PlayActivity)
        val view = LayoutInflater.from(this@PlayActivity).inflate(R.layout.activity_wrong_answers, null)
        builder.setView(view)
    ...
    private fun timeOverAlertDialog() {
        val builder = AlertDialog.Builder(this@PlayActivity)
        val view = LayoutInflater.from(this@PlayActivity).inflate(R.layout.activity_time_over, null)
        builder.setView(view)
